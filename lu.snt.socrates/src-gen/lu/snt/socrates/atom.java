 ...
 * </p>
 * <ul>
 *   <li>{@link lu.snt.socrates.atom#getF <em>F</em>}</li>
 *   <li>{@link lu.snt.socrates.atom#getS1 <em>S1</em>}</li>
 *   <li>{@link lu.snt.socrates.atom#getOp <em>Op</em>}</li>
 *   <li>{@link lu.snt.socrates.atom#getS2 <em>S2</em>}</li>
 * </ul>
 *
 * @see lu.snt.socrates.SocratesPackage#getatom()
 * @model
 * @generated
 */
public interface atom extends EObject
{
   ...
   * @see #setF(formula)
   * @see lu.snt.socrates.SocratesPackage#getatom_F()
  ...
  /**
   * Sets the value of the '{@link lu.snt.socrates.atom#getF <em>F</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see lu.snt.socrates.SocratesPackage#getatom_S1()
   * @model containment="true"
   * @generated
   */
  expression getS1();
  ...
  /**
   * Sets the value of the '{@link lu.snt.socrates.atom#getS1 <em>S1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOp(String)
   * @see lu.snt.socrates.SocratesPackage#getatom_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link lu.snt.socrates.atom#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see lu.snt.socrates.SocratesPackage#getatom_S2()
   * @model containment="true"
   * @generated
   */
  expression getS2();
  ...
  /**
   * Sets the value of the '{@link lu.snt.socrates.atom#getS2 <em>S2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
