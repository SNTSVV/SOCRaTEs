 ...
 * </p>
 * <ul>
 *   <li>{@link lu.snt.socrates.impl.SqrtImpl#getExp1 <em>Exp1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqrtImpl extends MinimalEObjectImpl.Container implements Sqrt
{
  ...
  {
    return SocratesPackage.Literals.SQRT;
  }
  ...
  public NotificationChain basicSetExp1(expression newExp1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SocratesPackage.SQRT__EXP1, oldExp1, newExp1);
  ...
  public void setExp1(expression newExp1)
  {
    if (newExp1 != exp1)
    {
      ...
      if (exp1 != null)
        msgs = ((InternalEObject)exp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SocratesPackage.SQRT__EXP1, null, msgs);
      if (newExp1 != null)
        msgs = ((InternalEObject)newExp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SocratesPackage.SQRT__EXP1, null, msgs);
      msgs = basicSetExp1(newExp1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SocratesPackage.SQRT__EXP1, newExp1, newExp1));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SocratesPackage.SQRT__EXP1:
