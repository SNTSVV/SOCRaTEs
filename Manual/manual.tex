...
\caption{The requirement Test$\_$Forall.}
  \centering
    \includegraphics[width=0.8\textwidth]{Req1.pdf}
\end{figure}
...
\caption{The requirement  Test$\_$Exists.}
  \centering
    \includegraphics[width=0.95\textwidth]{Req2.pdf}
\end{figure}
...
\caption{The evaluation of the oracle for the requirement Test$\_$Forall  and the model Model~1.}
  \centering
    \includegraphics[width=0.5\textwidth]{resModel1TestForall.pdf}
\end{figure}
...
\caption{The evaluation of the oracle for the requirement Test$\_$Forall  and the model Model~2.}
  \centering
    \includegraphics[width=0.5\textwidth]{resModel2TestForall.pdf}
\end{figure}
