...
Section~1 provides an overview on SOCRaTEs.
Section~2 describes how to install SOCRaTEs and how to create your first SOCRaTEs project.
Section~3 describes how to use SOCRaTEs.
Finally Section~4 provides a  tutorial that describes how to use SOCRaTEs on a set of simple examples.
